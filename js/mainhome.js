...
$(function(){
    ...
    $(".web_page_menu ul li").eq(1).click(function(){
        ...
        $(".hana_notebook").css({"animation":"hana_notebook 0.5s 2.6s ease forwards"})
        $(".hana_page").css({"animation":"hana_page 0.5s 3s ease forwards"})
    })
    ...
    $(".web_page_menu ul li").eq(5).click(function(){
        ...
        $(".indigo_pc_page").css({"animation":"indigo_pc 0.5s 3.2s ease forwards"})
        $(".indigo_mobile1").css({"animation":"indigo_mobile1 0.5s 3.3s ease forwards"})
        $(".indigo_mobile2").css({"animation":"indigo_mobile2 0.5s 3.4s ease forwards"})
